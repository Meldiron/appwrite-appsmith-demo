<template>
  ...
  >
    ...
    <form
      ...
      "
    >
      <img src="/logo.png" alt="" class="h-44 rounded-lg" />
      <p class="text-center">
        This is demo application showcasing how
        <b class="capitalize">easy</b> it is to connect
        <b class="capitalize">appwrite</b> with
        <b class="capitalize">Appsmith</b>. To see it in action, log in!
      </p>
      <button
        type="submit"
        class="
